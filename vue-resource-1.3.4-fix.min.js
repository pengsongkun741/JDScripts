...
!function(t, e) {
    ...
    function T(t, e, n) {
        for (var o in e)
            n && (h(e[o]) || Q(e[o])) ? (h(e[o]) && !h(t[o]) && (t[o] = {}),
            Q(e[o]) && !Q(t[o]) && (t[o] = []),
            T(t[o], e[o], n)) : void 0 !== e[o] && (t[o] = e[o])
    }
    function x(t, e, n) {
        var o = j(t)
          , r = o.expand(e);
            ...
            expand: function(o) {
                return t.replace(/\{([^\{\}]+)\}|([^\{\}]+)/g, function(t, r, i) {
                    if (r) {
                        var u = null
                          , s = [];
                        if (-1 !== e.indexOf(r.charAt(0)) && (u = r.charAt(0),
                        r = r.substr(1)),
                        r.split(/,/g).forEach(function(t) {
                            var e = /([^:\*]*)(?::(\d+)|(\*))?/.exec(t);
                            s.push.apply(s, E(o, u, e[1], e[2] || e[3])),
                            n.push(e[1])
                        }),
                        u && "+" !== u) {
                            var a = ",";
                            return "?" === u ? a = "&" : "#" !== u && (a = u),
                            (0 !== s.length ? u : "") + s.join(a)
                        }
                        return s.join(",")
                    }
                    return $(i)
        ...
        if (O(r) && "" !== r)
            if ("string" == typeof r || "number" == typeof r || "boolean" == typeof r)
                ...
                Array.isArray(r) ? r.filter(O).forEach(function(t) {
                    ...
                    O(r[t]) && (u.push(encodeURIComponent(t)),
                    u.push(C(e, r[t].toString())))
                }),
    ...
    function C(t, e, n) {
        return e = "+" === t || "#" === t ? $(e) : encodeURIComponent(e),
    ...
    function U(t, e) {
        ...
        r = b({}, U.options, o.$options, r),
        U.transforms.forEach(function(t) {
            c(t) && (t = U.transform[t]),
            f(t) && (n = R(t, n, o.$vm))
        }),
        n(r)
    ...
    function A(t, e, n) {
        ...
        v(e, function(e, u) {
            o = p(e) || Q(e),
            n && (u = n + "[" + (i || o ? u : "") + "]"),
            !n && r ? t.add(e.name, e.value) : o ? A(t, e, u) : t.add(u, e)
        })
    }
    function S(t) {
        var e = t.match(/^\[|^\{(?!\{)/)
    ...
    function B(t) {
        var n = this || {}
          , r = lt(n.$vm);
        return g(t || {}, n.$options, B.options),
        B.interceptors.forEach(function(t) {
            c(t) && (t = B.interceptor[t]),
            f(t) && r.use(t)
        }),
    ...
    var F, G = {}.hasOwnProperty, V = [].slice, _ = !1, z = "undefined" != typeof window, K = function(t) {
        ...
        var n = e(t);
        return c(t.root) && !/^(https?:)?\//.test(n) && (n = u(t.root, "/") + "/" + n),
        n
    }, tt = function(t, e) {
    ...
    U.transforms = ["template", "query", "root"],
    U.params = function(t) {
        var e = []
    ...
    var nt = function(t) {
      ...
      , rt = function(t, e) {
        if (z) {
            var n = U.parse(location.href)
              , o = U.parse(t.getUrl());
            o.protocol === n.protocol && o.host === n.host || (t.crossOrigin = !0,
            t.emulateHTTP = !1,
            ot || (t.client = nt))
        }
        e()
      ...
      , it = function(t, e) {
        l(t.body) ? t.headers.delete("Content-Type") : p(t.body) && t.emulateJSON && (t.body = U.params(t.body),
        t.headers.set("Content-Type", "application/x-www-form-urlencoded")),
        e()
    }
      , ut = function(t, e) {
        var n = t.headers.get("Content-Type") || "";
        p(t.body) && 0 === n.indexOf("application/json") && (t.body = JSON.stringify(t.body)),
        e(function(t) {
            return t.bodyText ? m(t.text(), function(e) {
                if (0 === (n = t.headers.get("Content-Type") || "").indexOf("application/json") || S(e))
                    try {
                        t.body = JSON.parse(e)
                    } catch (e) {
                        t.body = null
      ...
      , st = function(t) {
        return new e(function(e) {
            ...
            n = function(n) {
                var r = n.type
                  , s = 0;
                "load" === r && null !== u ? s = 200 : "error" === r && (s = 500),
      ...
      , lt = function(t) {
        function o(o) {
            return new e(function(e, s) {
                function a() {
                    f(r = i.pop()) ? r.call(t, o, c) : (n("Invalid interceptor of type " + typeof r + ", must be a function"),
                    c())
                }
                function c(n) {
                    if (f(n))
    ...
    var yt = function(t, e) {
        ...
        this.status = r || 0,
        this.statusText = i || "",
        this.headers = new mt(o),
        this.body = t,
        c(t) ? this.bodyText = t : d(t) && (this.bodyBlob = t,
        L(t) && (this.bodyText = H(t)))
    };
    ...
    B.interceptors = ["before", "method", "jsonp", "json", "form", "header", "cors"],
